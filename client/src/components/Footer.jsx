            ...
            <div className="lg:col-span-1">
              <div className="flex items-center space-x-3 mb-4">
                <a href="https://houseofhumanity.in/" target="_blank" rel="noopener noreferrer">
                  <img src={hohLogo} alt="House of Humanity" className="h-14 transition duration-200" />
                </a>
                <div className="h-8 border-l-2 border-gray-300 mx-2"></div>
                <img src={logo} alt="Project Sitaare" className="h-14 transition duration-200" />
              </div>
              <p className="text-[#BC1782]/80 leading-relaxed mb-4">
            
𝐀 𝐬𝐚𝐟𝐞-𝐬𝐩𝐚𝐜𝐞, 𝐰𝐡𝐞𝐫𝐞 𝐋𝐨𝐬𝐭 𝐂𝐡𝐢𝐥𝐝𝐡𝐨𝐨𝐝𝐬 𝐟𝐢𝐧𝐝 𝐋𝐨𝐯𝐞 𝐀𝐠𝐚𝐢𝐧.
𝐂𝐫𝐞𝐚𝐭𝐢𝐧𝐠 𝐇𝐄𝐑𝐬𝐭𝐨𝐫𝐲 𝐨𝐯𝐞𝐫 𝐇𝐈𝐒𝐭𝐨𝐫𝐲.
            ...
            <div className="lg:col-span-1 lg:ml-40">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-[#BC1782]/80">
                  ...
                  <span className="text-sm">6, Ashapuri Society, Near Akota Tea Post, Vadodara, Gujarat, India 390007</span>
                </div>
                <div className="flex items-center gap-3 text-[#BC1782]/80">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-xs text-[#BC1782]/60 mt-1">
                Made with <FaHeart className="inline text-[#D61A91] text-xs mx-1" /> for a better tomorrow
              </p>
            </div>
